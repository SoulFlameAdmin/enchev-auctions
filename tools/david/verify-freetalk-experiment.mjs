...
for(const token of ['DAVID_CHATGPT_TAB_TARGET="1"','DAVID_PROJECT_EFFORT_MODE="instant"','DAVID_GLOBAL_SEND_INTERVAL_MS="1500"','ChatGPT=1']) if(!singleStart.includes(token)) throw new Error("FAST SOLO start invariant missing: "+token);
