...
if(-not$ok){throw "AUTONOMY health gate failed: $last; expected CONTROL=0 DESIGN=0 and ChatGPT=3"}
...
Write-Host "[DAVID AUTONOMY] HEALTHY // ENCHEV SYSTEM + DPP + DAVID APK // CONTROL OFF // DESIGN OFF // ChatGPT=3" -ForegroundColor Green
