...
export function validate(strategy, runnerSource, packageJson) {
  ...
  if (!packageJson?.scripts || packageJson.scripts.test !== "node scripts/verify-staging-smoke-suite-ci.mjs --self-test && node scripts/run-ci-tests.mjs") fail("package test script must preserve the 25.12 pre-gate and canonical aggregate runner");
