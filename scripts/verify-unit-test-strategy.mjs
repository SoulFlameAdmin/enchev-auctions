...
export function validate(strategy, runnerSource, packageJson) {
  ...
  if (!packageJson?.scripts || packageJson.scripts.test !== "node scripts/run-system-test-pre-gates.mjs && node scripts/run-ci-tests.mjs") fail("package test script must preserve the stable system pre-gate runner and canonical aggregate runner");
