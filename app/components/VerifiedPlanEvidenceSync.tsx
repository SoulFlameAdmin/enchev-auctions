...
const VERIFIED_WAVE_0: Record<string, string> = {
  ...
  "02.05": "packages/domain workspace · @enchev/domain package · framework-independent public entrypoint · packages/domain/boundary.json · scripts/verify-packages-domain.mjs · merged via PR #37 at 43c6e2bc382e729c6a3abbf946e47216660ee721 · GitHub Actions run 35405204175 PASS · packages/domain boundary PASS · self-tests PASS · CI aggregate PASS · TypeScript PASS · production build PASS · health smoke PASS · visual regression PASS",
