...
- browser-only 10-second auction rotation/demo logic;
...
- repository `main` before this task: `de3f68de40dafd86a5485e2ba15c63d1c54134ed`;
- active Vercel production project is `enchev-auctions`, with the current main deployment READY;
- connected Supabase project `soulflame-twins` is `ACTIVE_HEALTHY` and shared with other applications;
...
- current marketplace cards and bid rotation are demo/browser state and therefore A4/A2, not authoritative auction data.
